...
void setup(void) {
  ...
  tags[0] =  { "0x40x1410x1510x2340x2010x720x128", "foot", 0, 60000, {random(1, 256), 150, 255}, 0};
  tags[1] =  { "0x40x1220x1510x2340x2010x720x128", "knuckle", 1, 60000, {random(1, 256), 150, 255}, 0};
  tags[2] =  { "0x40x1420x1510x2340x2010x720x128", "pear", 2, 60000, {random(1, 256), 150, 255}, 0};
  tags[3] =  { "0x40x1100x1510x2340x2010x720x129", "jawbone", 3, 60000, {random(1, 256), 150, 255}, 0};
  tags[4] =  { "0x40x1210x1510x2340x2010x720x128", "pebblevial", 4, 60000, {random(1, 256), 150, 255}, 0};
  tags[5] =  { "0x40x1250x1510x2340x2010x720x129", "cowbell", 5, 60000, {random(1, 256), 150, 255}, 0};
  tags[6] =  { "0x40x750x1700x2340x2010x720x129",  "scentedbox", 6, 60000, {random(1, 256), 150, 255}, 0};
  tags[7] =  { "0x40x1560x1510x2340x2010x720x128", "globe", 7, 60000, {random(1, 256), 150, 255}, 0};
  tags[8] =  { "0x40x1350x1510x2340x2010x720x128", "smallbottle", 8, 60000, {random(1, 256), 150, 255}, 0};
  tags[9] =  { "0x40x1110x1510x2340x2010x720x129", "compass", 9, 60000, {random(1, 256), 150, 255}, 0};
  tags[10] = { "0x40x1300x1510x2340x2010x720x129", "tea", 10, 60000, {random(1, 256), 150, 255}, 0};
  tags[11] = { "0x40x1020x1510x2340x2010x720x128", "spine", 11, 60000, {random(1, 256), 150, 255}, 0};
  tags[12] = { "0x40x1440x1510x2340x2010x720x129", "mousejaws", 12, 60000, {random(1, 256), 150, 255}, 0};
  tags[13] = { "0x40x1360x1510x2340x2010x720x128", "birdbones", 13, 60000, {random(1, 256), 150, 255}, 0};
  tags[14] = { "0x40x890x1700x2340x2010x720x129",  "musicbox", 14, 60000, {random(1, 256), 150, 255}, 0};
  tags[15] = { "0x40x1310x1510x2340x2010x720x129", "barth", 15, 60000, {random(1, 256), 150, 255}, 0};
  tags[16] = { "0x40x30x1510x2340x2010x720x129",   "feathervial", 16, 60000, {random(1, 256), 150, 255}, 0};
  tags[17] = { "0x40x530x1700x2340x2010x720x129",  "cowtooth", 17, 60000, {random(1, 256), 150, 255}, 0};
  tags[18] = { "0x40x1110x1700x2340x2010x720x129", "whistle", 18, 60000, {random(1, 256), 150, 255}, 0};
  tags[19] = { "0x40x740x1700x2340x2010x720x129",  "smallbell", 19, 60000, {random(1, 256), 150, 255}, 0};
  tags[20] = { "0x40x1250x1500x2340x2010x720x129", "crowvial", 20, 60000, {random(1, 256), 150, 255}, 0};
