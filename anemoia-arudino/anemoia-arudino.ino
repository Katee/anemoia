...
void setup(void) {
  ...
  tags[22] = { "0x40x1760x1510x2340x2010x720x128",  "vial", 21, 60000, 0};
  tags[23] = { "0x40x1450x1510x2340x2010x720x129", "knife", 22, 60000, 0};
  tags[24] = { "0x40x2450x1510x2340x2010x720x128", "scroll", 23, 60000, 0};
